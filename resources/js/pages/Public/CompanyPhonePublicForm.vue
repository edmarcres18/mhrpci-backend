    ...
    <div class="container">
      ...
      <form class="form" @submit.prevent="submit">
        ...
        <div class="field">
          ...
          <Input v-model="form.phone_number" class="input" placeholder="e.g. 09123456789" maxlength="11" />
        ...
        <div class="field">
          ...
          <Input v-model="form.extension" class="input" placeholder="e.g. 123" maxlength="20" />
        </div>
        </div>
        ...
        <div class="email-link">
          <a href="/public/emails" class="link">Submit an Company Email? click here</a>
        </div>
      </form>
    </div>
