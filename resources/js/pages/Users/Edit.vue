...
function submit() {
  ...
  form
    ...
    .post(`/users/${props.user.id}`, {
      ...
      onError: () => {
        showToast('error', 'Failed to update user. Please check the form.');
      },
    });
}
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="mx-auto w-full max-w-3xl p-4">
      ...
      <form @submit.prevent="submit" class="space-y-6 rounded-xl border border-sidebar-border/70 bg-white p-6 shadow-sm dark:border-sidebar-border dark:bg-neutral-950 sm:p-8">
        ...
        <div class="space-y-4 rounded-xl border border-neutral-200 bg-neutral-50 p-6 dark:border-neutral-800 dark:bg-neutral-900/50">
          <div class="flex items-center gap-2">
            ...
            <div>
              <h3 class="text-sm font-semibold text-neutral-700 dark:text-neutral-200">Change Password (Optional)</h3>
              <p class="text-xs text-neutral-500 dark:text-neutral-400">Leave blank to keep the current password</p>
            </div>
          </div>
          
          <div class="space-y-4">
            <div class="space-y-2">
              <label class="block text-sm font-semibold text-neutral-700 dark:text-neutral-200">New Password</label>
              <div class="relative">
                <input 
            ...
            <div class="space-y-2">
              <label class="block text-sm font-semibold text-neutral-700 dark:text-neutral-200">Confirm New Password</label>
              <div class="relative">
                <input 
