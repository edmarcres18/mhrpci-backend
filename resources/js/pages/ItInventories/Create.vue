...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="mx-auto w-full max-w-3xl p-4">
      ...
      <h1 class="mb-4 text-xl font-semibold">Create Inventory</h1>
      ...
      <form @submit.prevent="submit" class="space-y-5">
        ...
        <div class="flex items-center justify-end gap-3">
          ...
          <button type="submit" :disabled="form.processing" class="rounded-md bg-black px-4 py-2 text-sm font-medium text-white disabled:opacity-60 dark:bg-white dark:text-black">Create</button>
        </div>
      </form>
    </div>
  </AppLayout>
